    ...
    def deploy(
        ...
        try:
            ...
            env_vars = {
                ...
                'FANGYU_SITE_ID': site_id,
                'FANGYU_APP_ID': app_id,
                'FANGYU_APP_SECRET': app_secret,
...
环境变量:
  ...
  CF_ZONE_ID      : Cloudflare Zone ID
    ...
    parser.add_argument('--site-id', required=True,
                        help='Fangyu 站点 ID（如 site_xxxxxxxx）')
    parser.add_argument('--app-id', required=True,
                        help='Fangyu 应用 ID（数字）')
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        ...
        FANGYU_SITE_ID = "site_eba8689a"
        FANGYU_APP_ID = "1"
        FANGYU_APP_SECRET = "bd5f8a076002101ff410fd127dd5d5e71452c00e9aa479bf"
        ...
        try:
            ...
            success = deployer.deploy(
                ...
                site_id=FANGYU_SITE_ID,
                app_id=FANGYU_APP_ID,
                app_secret=FANGYU_APP_SECRET,
                zone_id=zone_id,
