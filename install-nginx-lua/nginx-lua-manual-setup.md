...
server {
    listen 80 ; 
    listen 443 ssl ; 
    server_name wayaifair.shop; 


    include /www/sites/wayaifair.shop/lua/fangyu_real_ip.conf;

    # Fangyu Defense 配置
    set $fangyu_gateway_url  "https://gateway.foxfingerlab.com";
    set $fangyu_site_key     "site_eba8689a";
    set $fangyu_site_id      "1";
    set $fangyu_site_secret  "bd5f8a076002101ff410fd127dd5d5e71452c00e9aa479bf";
    ...
    access_log /www/sites/wayaifair.shop/log/access.log main; 
    error_log /www/sites/wayaifair.shop/log/error.log; 
    ...
    location / {
        access_by_lua_file /www/sites/wayaifair.shop/lua/defense.lua;
    ...
    ssl_certificate /www/sites/wayaifair.shop/ssl/fullchain.pem; 
    ssl_certificate_key /www/sites/wayaifair.shop/ssl/privkey.pem; 
